  ...
  return (
    <header className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
        ...
        >
          ...
          <div className="flex items-center justify-center mb-6">
            <motion.div
              ...
              className="bg-amber-500 p-4 rounded-full shadow-xl"
            >
          ...
          <motion.h1
            ...
            className="font-playfair text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4"
          >
            Better Menu
          </motion.h1>
          ...
          >
            Discover our carefully crafted culinary experiences with fresh ingredients and exceptional flavors
          </motion.p>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg
          className="w-full h-8 text-slate-50"
